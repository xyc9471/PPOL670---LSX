...
```{r echo=FALSE, width = "500px"}
knitr::include_graphics("/Users/apple/Documents/GitHub/PPOL670---LSX/outputs/visualizations/area.png")
```
Figure 3 shows the difference in income levels for both genders in rural and urban settings. As we can see, the difference in rural and urban income is quite significant. Urban males earn more than 70 percent more than rural males. This contrast also exists for females, but the difference is significantly lower. In this case, urban females only earn 40 percent more than rural females. 

We also looked at income change for both genders as the number of children increases. Figure 4 shows the change in income as the number of children increases. For both genders, as the number of children increases income gradually decreases at the same level. One difference does exists at three children. We see income levels slightly recover for both genders, however, this recovery is much more pronounced for males. Furthermore, after three kids, while males’ income falls at the previous rate of decrease before three kids, women’s income levels decreases much more rapidly .(Figure in appendix)
...
# Figure 2
```{r echo=FALSE, width = "500px"}
knitr::include_graphics("/Users/apple/Documents/GitHub/PPOL670---LSX/outputs/visualizations/numkids.png")
```
